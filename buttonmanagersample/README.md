...
*	Copy the 'target/buttonmanagersample-1.0-SNAPSHOT.war' into your 'tomcat/webapps' directory.
*	Start your tomcat if it's not already running.
*	Access 'http://<your-server-host:port>/buttonmanagersample-1.0-SNAPSHOT/' in your browser to play with the test pages.