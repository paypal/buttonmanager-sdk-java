...
*	Download the project from github, build project using build.xml with default ant target, which will create 'buttonmanager-java-sdk_1.0.93.jar' inside 'dist' folder.

*	Copy 'buttonmanager-java-sdk_1.0.93.jar' inside 'dist' folder under SDK root, to your class path.
